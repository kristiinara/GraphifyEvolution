...
To run GraphifySwiftEvolution and run `swift build`. When the build succeeds the GraphifySwiftEvolution executable can be found in .build/debug.

### Running GraphifySwiftEvolution

Analyse an application:
      
    GraphifySwiftEvolution analyse <pathToRepository>
    
additional options: 
	
  --app_key <unique application key>  (optional)
  --evolution                         (analyse evolution of application, expects that application folder is a git repository)
